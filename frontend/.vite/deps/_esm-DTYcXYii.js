import { $i as concat, $n as AtomicityNotSupportedError, $r as prettyPrint, $t as withResolvers, Aa as hexToBool, An as fromNumber, Ao as textResolverAbi, Ar as TimeoutError, Bn as fromHex$3, Ca as boolToHex, Cn as multicall3Bytecode, Co as erc1271Abi, Cr as UnsupportedNonOptionalCapabilityError, Da as toHex$1, Di as parseAbiParameter$1, Dn as from$10, Do as erc6492SignatureValidatorAbi, Dr as HttpRequestError, Ea as stringToHex, Ei as parseStructs, En as concat$1, Er as WalletConnectSessionSettlementError, Fi as InvalidAbiParameterError, Fn as slice$1, Ga as AbiConstructorNotFoundError, Gi as modifiers, Gn as toBoolean, Gr as InvalidSerializedTransactionError, Hi as InvalidAbiItemError, Hn as size$3, Ii as InvalidAbiParametersError, In as toNumber$1, Ir as CallExecutionError, Ja as AbiDecodingDataSizeTooSmallError, Ji as decodeAbiParameters, Jn as trimLeft, Jr as TransactionExecutionError, Ka as AbiConstructorParamsNotFoundError, Ki as formatAbiItem$1, Kn as toNumber, Kr as InvalidSerializedTransactionTypeError, La as InvalidHexValueError, Ln as trimLeft$1, Lr as ContractFunctionExecutionError, Mn as padLeft, Mo as universalResolverReverseAbi, Na as trim, Nn as padRight, Oi as parseSignature$1, On as fromBoolean, Or as RpcRequestError, Pn as size$2, Qa as AbiEncodingLengthMismatchError, Qi as integerRegex$1, Qn as AtomicReadyWalletRejectedUpgradeError, Qr as WaitForTransactionReceiptTimeoutError, Qt as createBatchScheduler, Rn as validate$3, Rr as ContractFunctionRevertedError, Sa as toBytes, Si as toEventSelector, Sn as erc6492SignatureValidatorByteCode, Sr as UnsupportedChainIdError, Ta as numberToHex, Tn as IntegerOutOfRangeError, Tr as UserRejectedRequestError, Un as slice$2, Ur as InvalidLegacyVError, Va as padHex, Vn as fromString, Vr as RawContractError, Wa as InvalidAddressError$1, Wi as isStructSignature, Wn as toBigInt, Wr as InvalidSerializableTransactionError, Xi as arrayRegex$1, Xn as stringify$1, Xr as TransactionReceiptNotFoundError, Ya as AbiDecodingZeroDataError, Yi as encodeAbiParameters, Yn as validate$4, Yr as TransactionNotFoundError, Zi as bytesRegex$1, Zn as BaseError$1, Zr as TransactionReceiptRevertedError, Zt as serializeStateOverride, _a as keccak_256, _i as encodeFunctionData, _r as SwitchChainError, ai as etherUnits, an as getCallError, ar as InvalidParamsRpcError, bi as getAbiItem, bn as deploylessCallViaBytecodeBytecode, bo as formatAbiItem, br as UnknownBundleIdError, c as assertRequest, ci as stringify, cn as FeeCapTooHighError, co as BytesSizeMismatchError$1, cr as LimitExceededRpcError, ct as maxUint256$1, da as PositionOutOfBoundsError$1, di as getChainContractAddress, dr as ParseRpcError, er as BundleTooLargeError, fa as checksumAddress, fr as ProviderDisconnectedError, ga as keccak256$1, gi as InvalidChainIdError, gn as TipAboveFeeCapError, go as BaseError, ha as LruMap$1, ho as UnsupportedPackedAbiType, hr as ResourceUnavailableRpcError, in as extract$1, io as AbiEventSignatureNotFoundError, ir as InvalidInputRpcError, ja as hexToNumber, jn as fromString$1, jo as universalResolverResolveAbi, jr as WebSocketRequestError, ka as hexToBigInt, ki as splitParameters, kn as fromBytes$2, ko as multicall3Abi, kr as SocketClosedError, la as sliceHex, lo as DecodeLogDataMismatch, lr as MethodNotFoundRpcError, ma as isAddress, mi as ChainNotFoundError, mr as ResourceNotFoundRpcError, ni as formatGwei, no as AbiEventNotFoundError, nr as DuplicateIdError, o as isAddressEqual, oi as gweiUnits, on as getNodeError, or as InvalidRequestRpcError, pa as getAddress, pi as ChainMismatchError, qi as formatAbiParameters, qn as toString, qr as InvalidStorageKeySizeError, ri as formatEther, rn as defineFormatter, ro as AbiEventSignatureEmptyTopicsError, rr as InternalRpcError, s as call, sa as slice, sn as ExecutionRevertedError, sr as JsonRpcVersionUnsupportedError, ta as concatHex, tn as formatTransactionRequest, tr as ChainDisconnectedError, ua as createCursor, ui as parseAccount, uo as DecodeLogTopicsMismatch, ur as MethodNotSupportedRpcError, vn as UnknownNodeError, vo as size$1, vr as TransactionRejectedRpcError, wa as bytesToHex, wn as toRpc, wr as UnsupportedProviderMethodError, xa as stringToBytes, xo as addressResolverAbi, xr as UnknownRpcError, ya as hexToBytes, yi as decodeFunctionResult, yn as encodeDeployData, yo as isHex, yr as UnauthorizedProviderError, za as pad, zn as from$9, zr as ContractFunctionZeroDataError } from "./ccip-C-muXWFN.js";
import { D as clean, N as rotl, k as createHasher } from "./utils-BepS8HO6.js";
import { i as HashMD, r as sha256$2, t as secp256k1 } from "./secp256k1-D6UhEd4X.js";
...
async function recoverPublicKey$1({ hash, signature }) {
	...
	const { secp256k1 } = await import("./secp256k1-D6UhEd4X.js").then((n) => n.n);
	return `0x${(() => {
...
function getCreateAddress(opts) {
	...
	return getAddress(`0x${keccak256$1(toRlp([from, nonce], "bytes")).slice(26)}`);
}
function getCreate2Address(opts) {
	...
	const bytecodeHash = (() => {
		...
		return keccak256$1(opts.bytecode, "bytes");
	})();
	return getAddress(slice(keccak256$1(concat([
		toBytes("0xff"),
		from,
		salt,
		bytecodeHash
...
function isHash(hash) {
	return isHex(hash) && size$1(hash) === 32;
}
//#endregion
...
async function getWebSocketRpcClient(url, options = {}) {
	...
	return getSocketRpcClient({
		async getSocket({ onClose, onError, onOpen, onResponse }) {
			const WebSocket = await import("./native-53MoLNrR.js").then((module) => module.WebSocket);
	...
	const validateData = (struct, data) => {
		for (const param of struct) {
			...
			if (bytesMatch) {
				...
				if (size_ && size$1(value) !== Number.parseInt(size_, 10)) throw new BytesSizeMismatchError$1({
...
function hashType({ primaryType, types }) {
	return keccak256$1(toHex$1(encodeType({
		primaryType,
		types
	})));
}
...
function encodeField({ types, name, type, value }) {
	...
	if (type === "string") return [{ type: "bytes32" }, keccak256$1(toHex$1(value))];
...
function from$8(value) {
	const publicKey = (() => {
		if (validate$3(value)) return fromHex$2(value);
		if (validate$4(value)) return fromBytes$1(value);
...
function fromPublicKey(publicKey, options = {}) {
	return from$7(`0x${keccak256(`0x${toHex(publicKey).slice(4)}`).substring(26)}`, options);
}
/**
...
*/
async function verifyHash$1({ address, hash, signature }) {
	return isAddressEqual(getAddress(address), await recoverAddress$1({
		hash,
		signature
	}));
}
...
async function signMessage(client, { account: account_ = client.account, message }) {
	...
	const message_ = (() => {
		...
		if (message.raw instanceof Uint8Array) return toHex$1(message.raw);
		return message.raw;
	})();
	return client.request({
...
async function recoverTransactionAddress(parameters) {
	...
	return await recoverAddress$1({
		hash: keccak256$1(serializeTransaction({
			...transaction,
			r: void 0,
			s: void 0,
			v: void 0,
...
//#endregion
export { verifyMessage as $, FilterTypeNotSupportedError as $n, assertCurrentChain as $t, writeContractSync as A, blobsToProofs as An, hashTypedData as At, waitForCallsStatus as B, formatTransaction as Bn, presignMessagePrefix as Bt, createTestClient as C, prepareTransactionRequest as Cn, parseErc8010Signature as Ct, createClient as D, commitmentsToVersionedHashes as Dn, zeroHash as Dt, publicActions as E, toBlobs as En, isErc6492Signature as Et, signMessage as F, getGasPrice as Fn, InvalidDomainError as Ft, deployContract as G, MaxFeePerGasTooLowError as Gn, ripemd160 as Gt, getCapabilities as H, BlockNotFoundError as Hn, withTimeout as Ht, showCallsStatus as I, getBlock as In, InvalidPrimaryTypeError as It, watchContractEvent as J, hexToRlp as Jn, formatTransactionReceipt as Jt, sendTransaction as K, EstimateGasExecutionError as Kn, isHash as Kt, sendTransactionSync as L, defineBlock as Ln, InvalidStructTypeError as Lt, watchAsset as M, getTransactionCount as Mn, getTypesForEIP712Domain as Mt, signTypedData as N, estimateFeesPerGas as Nn, serializeTypedData as Nt, rpcSchema as O, commitmentToVersionedHash as On, hashDomain as Ot, signTransaction as P, estimateMaxPriorityFeePerGas as Pn, validateTypedData as Pt, verifyTypedData as Q, encodeEventTopics as Qn, extendSchema as Qt, sendCallsSync as R, formatBlock as Rn, hashMessage as Rt, walletActions as S, estimateGas as Sn, recoverMessageAddress as St, createPublicClient as T, toBlobSidecars as Tn, isErc8010Signature as Tt, getCallsStatus as U, BaseFeeScalarError as Un, createNonceManager as Ut, BundleFailedError as V, transactionType as Vn, rpc as Vt, sendCalls as W, Eip1559FeesNotSupportedError as Wn, nonceManager as Wt, waitForTransactionReceipt as X, recoverAddress$1 as Xn, extractChain as Xt, watchBlocks as Y, toRlp as Yn, fromRlp as Yt, watchBlockNumber as Z, recoverPublicKey$1 as Zn, defineChain as Zt, fallback as _, getBlockTransactionCount as _n, verifyMessage$1 as _t, parseCompactSignature as a, assertTransactionLegacy as an, EnsAvatarUnsupportedNamespaceError as ar, getTransactionReceipt as at, createTransport as b, getBlobBaseFee as bn, serializeErc6492Signature as bt, defineKzg as c, getCreateAddress as cn, getEnsAddress as cr, getStorageAt as ct, fromBlobs as d, getFeeHistory as dn, labelhash as dr, parseEther as dt, withRetry as en, getEnsResolver as er, serializeSignature as et, decodeDeployData as f, getContractEvents as fn, namehash as fr, parseUnits as ft, UrlRequiredError as g, getCode as gn, verifyTypedData$1 as gt, http as h, formatLog as hn, parseAbiItem as hr, getSerializedTransactionType as ht, parseSignature as i, assertTransactionEIP2930 as in, EnsAvatarInvalidNftUriError as ir, multicall as it, writeContract as j, blobsToCommitments as jn, domainSeparator as jt, getContract as k, sha256 as kn, hashStruct as kt, toCoinType as l, isBytes as ln, readContract as lr, getProof as lt, webSocket as m, decodeEventLog as mn, parseAbiParameter as mr, parseTransaction as mt, serializeCompactSignature as n, serializeAccessList as nn, getEnsAvatar as nr, ethAddress as nt, compactSignatureToSignature as o, getContractAddress as on, EnsAvatarUriResolutionError as or, getTransactionConfirmations as ot, ProviderRpcError as p, parseEventLogs as pn, parseAbiParameters as pr, InvalidDecimalNumberError as pt, watchPendingTransactions as q, bytesToRlp as qn, defineTransactionReceipt as qt, recoverTransactionAddress as r, assertTransactionEIP1559 as rn, getEnsText as rr, zeroAddress as rt, setupKzg as s, getCreate2Address as sn, EnsInvalidChainIdError as sr, getTransaction as st, signatureToCompactSignature as t, serializeTransaction as tn, getEnsName as tr, simulateContract as tt, sidecarsToVersionedHashes as u, encodePacked$1 as un, getContractError as ur, parseGwei as ut, shouldThrow as v, getBlockNumber as vn, verifyHash$1 as vt, testActions as w, getTransactionType as wn, parseErc6492Signature as wt, createWalletClient as x, getBalance as xn, recoverTypedDataAddress as xt, custom as y, withCache as yn, serializeErc8010Signature as yt, WaitForCallsStatusTimeoutError as z, defineTransaction as zn, toPrefixedMessage as zt };

//# sourceMappingURL=_esm-DTYcXYii.js.map